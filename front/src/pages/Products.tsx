...
import { Box, Container, Heading, Text, SimpleGrid, Slider, Color, HStack, Center, FormatNumber, Image, Flex, Accordion, Span } from "@chakra-ui/react";
...
export default function Product() {
	...
	return (
		<AnimatedPage>
			...
			<Slider.Root width="300px" defaultValue={[30, 60]} size={"lg"} textAlign="left" ml={10}>
				<Slider.Label><Text textStyle="2xl" mb = "5" color="#422F27">FLTER BY PRICE </Text></Slider.Label>
      			<Slider.Control>
        			<Slider.Track>
					...
					<Slider.Marks marks={[
											{ value: -10, label: <Text textStyle="1xl" color="#AB8371">$30</Text> },
											{ value: 110, label: <Text textStyle="1xl" color="#AB8371">$3500</Text>},
	  									]}
					/>
      			</Slider.Control>
    		</Slider.Root>
			<Accordion.Root multiple defaultValue={["b"]} width="70%" mt ="20" ml="10" color="black" >
			<Text fontWeight="semibold" textStyle="2xl" mb="5" color="#422F27">CATEGORIES </Text>
			...
			<SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} gap={{ base: 6, md: 10 }} mb="10%" width="60%">
